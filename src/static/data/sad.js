export function getSadList() {
    this.sadList = [
        ...
        "可以偶尔的释放一下本性，但切记一定要回归现实。",
        "光穿破云层，照亮了整片天空，却灰暗了我长久的时光。",
        "那些朝我泼冷水的人，谢谢你们，我省得回家洗头。",
        ...
        "你好 我叫不开心 很难过认识你。",
        "世人皆知山龄喜 无人知晓卢氏悲。",
        "世间八苦 除了生老病死 其他都是自寻苦楚",
        "你没有失去什么，你从来就是一无所有，不是吗？",
        "很多事 我能想通 也能接受 但我很难过。",
        "我对感情最大的误会 就是以为只要有付出 都会有回报。",
        "在个世界 看你笑话的人 永远比在乎你的多。",
        "习惯了 是个很强大的词 可以代替所有的一言难尽。",
        "仙人掌做不了花 没办法让人捧在手心里。",
        "不快乐的开关在哪 我要把它拆掉",
        "怪我不自量力 妄想徒手摘星",
        "你不过是仗着我喜欢你 所以你就随意践踏我",
        "满街游走，打听幸福的下落",
        "人间是个好地方 可我不想再来了",
        "希望戾气都悄悄溜走 余下的皆是温柔",
        "生活也就这样了 没有什么期待 也没什么好失望的",
        "念旧的人不适合混迹江湖。",
        "扬言陪我走完一生的你总是迷路.",
        "没有惊喜也没有失落除了偶尔自找难过.",
        "难过吗 再难过也都是我一个人挺过来的",
        ...
        "在泛泛之交里做那个最特别的靓妹",
        "春梦和艳事 最俗气也最让人快活。",
        "如果生活也可以选择 2倍速播放 那该多好",
        "世界上最危险的东西就是希望",
        "一想到大家终归都要死 我就原谅了所有人",
        "愿往后余生 不必逞强不必说谎 爱我的人都懂我的模样",
        "习惯了戴着面具微笑 即使背后全是泪水。",
        ...
        "爱笑的姑娘运气都不会太差。——我不知道运气差的姑娘她是怎么笑的出来的！",
        "你每天都那么努力，忍受了那么多的寂寞和痛苦。可我也没见你有多优秀。",
        ...
        "你这么努力，忍受那么多寂寞和痛苦，可是我们也没有觉得你有多优秀啊。",
        ...
        "没有人总是一帆风顺的，其实你并不寂寞。看看你身边的朋友，不就是因为失败才混在一块儿的嘛。",
        ...
        "一场说走就走的旅行归来后，除了该做的事情被拖延得更久了，什么都没有改变。",
        "如果上天没有给你想要的，不是你值得拥有更好的，而是你不配。别以为今天是你人生的低谷，在你未来的日子里它都能算得上是巅峰了。",
        "大部分人的成功靠的，不是厚积薄发的努力，也不是戏剧化的机遇，而是早就定好的天赋和出身。",
        "有人说，史上99%的事情是可以用金钱摆平的，但是他们没说的是，剩下的1%就是意味着要更多的钱。",
        "多年过去，再回忆高考，其实本质上没有考的好与坏的说法，重要的是年轻人在一起，做份试题，然后决定去哪座城市做代购。",
        "除了有钱人，世上还有两种人：其一是省吃俭用买奢侈品装逼，其二是省吃俭用也买不起奢侈品的。",
        "胖人为什么胖？你和他说垃圾食品致癌，他照吃。你说辣条会吃死人，他照吃。你和他谈减肥，他还会怕反弹回来所以不减。",
        ...
        "懒是一个很好的托辞，说得好像勤快了就真能干出什么大事儿一样；胖是一个很好的托辞，说得好像瘦了之后就真能有多好看一样；不想谈恋爱是一个很好的托辞，说得好像想恋爱时真能被人看上一样；年轻是一个很好的托辞，说得好像成熟了之后就真能有多大出息一样。"
    ]
}
